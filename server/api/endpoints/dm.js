...
module.exports = function() {
  ...
  router.get("/hubs/:hubId/projects/:projectId", async (req, res) => {
    try {
      ...
      const response = await dmSvc.getProject(token, hubId, projectId);
  ...
  router.get("/projects/:projectId/folders/:folderId", async (req, res) => {
    try {
      ...
      const response = await dmSvc.getFolder(token, projectId, folderId);
  ...
  /// //////////////////////////////////////////////////////
  router.get(
    // FIXME: might need to fix /contents at the end
  ...
  router.get("/projects/:projectId/items/:itemId", async (req, res) => {
    try {
      ...
      const response = await dmSvc.getItem(token, projectId, itemId);
  ...
  router.get(
    ...
    async (req, res) => {
      try {
        ...
        const response = await dmSvc.getItemVersions(token, projectId, itemId);
  ...
  //
  /// //////////////////////////////////////////////////////
  router.get("/projects/:projectId/items/:itemId/tip", async (req, res) => {
    try {
      const projectId = req.params.projectId;
      ...
      const response = await dmSvc.getItemTip(token, projectId, itemId);
  ...
  router.post(
    ...
    async (req, res) => {
      try {
        ...
        const getToken = () => forgeSvc.get3LeggedTokenMaster(req.session);

        const hubRes = await dmSvc.getHub(getToken, hubId);
  ...
  //
  /// //////////////////////////////////////////////////////
  router.delete("/projects/:projectId/items/:itemId", async (req, res) => {
    try {
      const projectId = req.params.projectId;
      ...
      const response = await dmSvc.deleteItem(token, projectId, itemId);
  ...
  router.delete(
    ...
    async (req, res) => {
      try {
        ...
        const response = await dmSvc.deleteVersion(token, projectId, versionId);
  ...
  router.get("/projects/:projectId/versions/:versionId", async (req, res) => {
    try {
      ...
      const response = await dmSvc.getVersion(token, projectId, versionId);
  ...
  /// //////////////////////////////////////////////////////
  router.get(
    "/projects/:projectId/versions/:versionId/relationships/refs",
    async (req, res) => {
      try {
        const projectId = req.params.projectId;
  ...
  router.get("/buckets/:bucketKey/objects/:objectKey", async (req, res) => {
    try {
      ...
      const details = await ossSvc.getObjectDetails(
        token,
        bucketKey,
        objectKey
      );
      ...
      const object = await ossSvc.getObject(token, bucketKey, objectKey);
