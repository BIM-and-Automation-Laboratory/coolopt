...
module.exports = function() {
  ...
  router.get("/systems/:systemId", async (req, res) => {
    try {
      ...
      const response = await forgeSvc.getSystemHooks(token, systemId);
  ...
  router.get("/systems/:systemId/events/:eventId", async (req, res) => {
    try {
      ...
      const response = await forgeSvc.getEventHooks(token, systemId, eventId);
  ...
  router.post("/systems/:systemId", async (req, res) => {
    try {
      ...
      const response = await forgeSvc.createSystemHook(token, systemId, params);
  ...
  //
  /// //////////////////////////////////////////////////////
  router.post("/systems/:systemId/events/:eventId", async (req, res) => {
    try {
      const { systemId, eventId } = req.params;
      ...
      const response = await forgeSvc.createEventHook(
        token,
        systemId,
        eventId,
        params
  ...
  /// //////////////////////////////////////////////////////
  router.delete(
    "/systems/:systemId/events/:eventId/:hookId",
    async (req, res) => {
      try {
        ...
        const response = await forgeSvc.removeHook(
          token,
          systemId,
          eventId,
          hookId
